...
import it.polito.wa2.g15.validatorservice.dtos.UserDetailsDTO
...
class JwtUtils {
    ...
    fun getDetailsJwt(authToken: String): UserDetailsDTO {
        ...
        val rolesSet: Set<GrantedAuthority> =
            (claims.body["roles"] as ArrayList<String>).map { SimpleGrantedAuthority(it) }.toSet()
    ...
    fun validateJwt(authToken: String?): Boolean {
        ...
        try {
            ...
            val fromJSONtoSet =
                jws.body["roles"] as? ArrayList<*> ?: throw ValidationException("No roles collection found")
